...
- TLS for HTTP clients moves from openssl (system certificate store) to rustls with the bundled webpki Mozilla root set; endpoints signed by OS-installed private CAs are no longer trusted (malbeclabs/infra#1853)
