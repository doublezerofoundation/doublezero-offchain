//! Cluster identification and gossip-node lookup helpers used by the passport
//! verbs. Moved verbatim from the offchain `doublezero-solana` binary's
//! `utils` module (these helpers were only ever used by passport).
