...
- (breaking) `TransactionOutcome` no longer derives `Eq`, and `Simulated` now boxes `RpcSimulateTransactionResult` (the type dropped `Eq` and grew in Solana 3.0) (malbeclabs/infra#1853)
