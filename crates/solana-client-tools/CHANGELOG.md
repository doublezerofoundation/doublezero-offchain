...
- feat(solana-client-tools): add program zero-copy account fetch helper ([#390](https://github.com/doublezerofoundation/doublezero-offchain/pull/390))
...
- tolerate missing and unparseable accounts in try*fetch_multiple_zero_copy_data. Return type is now Result<Vec<Option<*>>> (breaking) ([#374](https://github.com/doublezerofoundation/doublezero-offchain/pull/374))
