...
use doublezero_solana_sdk::{
    build_memo_instruction_with_compute_units, environment_2z_token_mint_key,
...
async fn try_prepare_distribution_rewards(
    ...
    let (memo_ix, memo_compute_units) = build_memo_instruction_with_compute_units(b"Relay");
