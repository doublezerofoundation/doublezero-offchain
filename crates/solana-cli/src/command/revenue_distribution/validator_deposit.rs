...
use doublezero_solana_sdk::{
    NetworkEnvironment, build_memo_instruction, build_memo_instruction_with_compute_units,
...
impl ValidatorDepositCommand {
    pub async fn try_into_execute(self) -> Result<()> {
        ...
        let (fund_lamports, memo_ix_and_compute_units) = if should_fund_outstanding_debt {
            ...
            let (memo_ix, memo_compute_units) = build_memo_instruction_with_compute_units(
        ...
        // most) to lamports.
            ...
            let (memo_ix, memo_compute_units) =
                build_memo_instruction_with_compute_units(b"Funded");
