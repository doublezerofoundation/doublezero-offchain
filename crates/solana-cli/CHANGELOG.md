...
## [Unreleased]
- `shreds pay`: allow `--amount 0` by accepting non-negative values instead of strictly positive ([#314](https://github.com/doublezerofoundation/doublezero-offchain/pull/314))
