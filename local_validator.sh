...
echo $SMARTCONTRACT_DIR
echo "Build DoubleZero Record program"
cd $SMARTCONTRACT_DIR/doublezero/smartcontract/programs/doublezero-record
cargo build-sbf

ROOT_DIR=$SMARTCONTRACT_DIR/doublezero
echo $ROOT_DIR
...
cd ~/src/malbec/doublezero-offchain/crates/validator-revenue
pwd
